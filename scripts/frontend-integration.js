 ...
 * This file demonstrates how to integrate Melodyyarn with a web frontend
 */

// For React/Vue/Angular applications
export class MelodyyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MelodyyarnClient(provider, contractAddress);
